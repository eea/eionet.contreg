...
public class UploadCSVActionBeanTest extends CRDatabaseTestCase {
    ...
    public static final String EXPECTED_SPARQL_WITH_LINKING_SCRIPTS =
            "PREFIX tableFile: <http://127.0.0.1:8080/cr/home/somebody/USPresidents.csv#> " + "SELECT * FROM <" + TEST_FOLDER_URI
                    + "/USPresidents.csv> WHERE {" + "    OPTIONAL { _:rec tableFile:Presidency ?Presidency } ."
