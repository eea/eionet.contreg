...
public class HarvestScriptParserTest {
    ...
    /** */
    private int limit = HarvestScriptParser.TEST_RESULTS_LIMIT;
    private String harvestedSource = "?" + HarvestScriptParser.HARVESTED_SOURCE_VARIABLE;

    /** The name of the variable to bind the RDF type to. */
    private String thisType = "?" + HarvestScriptParser.ASSOCIATED_TYPE_VARIABLE;
    ...
    public void testDeriveConstructFromModify() throws ScriptParseException {
        ...
        assertEquals(exptd, HarvestScriptParser.deriveConstruct(input, "http://", null));
    ...
    public void checkTypeExpansionForInsert() throws ScriptParseException {
        ...
        String actual = HarvestScriptParser.deriveConstruct(input, testSource, testType);
    ...
    public void checkTypeExpansionForModify() throws ScriptParseException {
        ...
        assertEquals(exptd, HarvestScriptParser.deriveConstruct(input, testSource, testType));
    }
    ...
    public void testParseForExecution() throws ScriptParseException {
        ...
        assertEquals(exptd, HarvestScriptParser.parseForExecution(input, testSource, testType));
    }
    ...
    public void testDeriveSelectFromSelect() {
        ...
        assertEquals(exptd, HarvestScriptParser.deriveSelect(input, testSource));
    }
