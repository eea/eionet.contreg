...
public class TestPostgreSQLFullTextQuery extends TestCase {
    ...
    public void test() {
        ...
        StringBuffer expected =
                new StringBuffer().append("Car").append(oper).append("blue").append(oper).append("lagoon").append(oper)
                        .append("this").append(oper).append("wasn't").append(oper).append("(bad | good)");
