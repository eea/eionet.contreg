        ...
        <c:choose>
            <c:when test="${not empty actionBean.bookmarks}">
                <crfn:form id="bookmarkForm"
                    ...
                    method="post">
                    <display:table name="${actionBean.bookmarks}" class="sortable" pagesize="20" sort="list" id="bookmark" htmlId="bookmarks" requestURI="${actionBean.parsedUrlBinding}" style="width:100%">
                        <c:if test="${ actionBean.userAuthorized}">
