...
<stripes:layout-render name="/pages/common/template.jsp" pageTitle="Harvesting Statistics">
        ...
        <c:choose>
            <c:when test="${actionBean.adminLoggedIn}">
                ...
                <ul>
                    ...
                    <li><stripes:link
                            href="/admin/endpointQueries.action">SPARQL endpoint harvest queries</stripes:link></li>
                    <li><stripes:link href="/admin/sourceDeletions.action">Monitor source deletions</stripes:link></li>
                    <li><stripes:link href="/admin/stagingDbs.action">Staging databases</stripes:link>&nbsp;<span
                            style="color:#FF0000">(work in progress!)</span></li>
