...
public class VirtuosoFilteredSearchHelper extends AbstractSearchHelper {
    ...
    /**
     * Shows if the query, generated by the helper will use inferencing.
     * true by default
     */
    private boolean useInferencing = true;
    ...
    /**
     * Indicates if the query uses inferencing.
     * @return boolean
     */
    ...
    /**
     * Returns StringBuilder based on useInference settings.
     * Definition of the rule is at the beginning of the query if the helper must use inferencing
