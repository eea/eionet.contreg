...
public abstract class VirtuosoBaseDAO {
    ...
    /** Virtuoso's own namespace prefix for blank nodes, not to be confused with the standard N3 blank node prefix (i.e. "_:"). */
    public static final String VIRTUOSO_BNODE_PREFIX = "nodeID://";

    /** The standard N3 namespace prefix for blank nodes, not to be confused with Virtuoso's own prefix for blank nodes. */
