 ...
 */
package eionet.cr.api.feeds.amp.old;
...
public class AmpProjectDTO implements Serializable {
	...
	@ElementList (required = false, name = "rdfs:label")
	...
	public AmpProjectDTO(SubjectDTO subject) {
		...
		this.label = Collections.singletonList(StringUtils.isBlank(label) ? "No label" : label);
