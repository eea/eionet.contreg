 ...
 * It all starts to thread from the {@link eionet.cr.util.liquibase.VirtuosoDatabase} class.
 * {@link eionet.cr.util.liquibase.CRLiquibaseServletListener} is the servlet context listener that ensures that the
 * {@link eionet.cr.util.liquibase.VirtuosoDatabase} class gets registered in Liquibase, and after that the processing is
