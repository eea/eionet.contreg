...
public class PostgreSQLDerivationEngine implements IDerivationEngine {
    ...
    public void deriveLabels() throws SQLException {
        ...
        StringBuffer buf =
                new StringBuffer()
                        ...
                        .append("where SPO_FRESH.SOURCE=")
                        .append(sourceUrlHash)
                        .append(" and SPO_FRESH.GEN_TIME=")
                        .append(genTime)
                        .append(" and SPO_FRESH.ANON_OBJ='N' and SPO_FRESH.LIT_OBJ='N' and SPO_FRESH.OBJECT_HASH=SPO_LABEL.SUBJECT and ")
                        .append("SPO_LABEL.LIT_OBJ='Y' and SPO_LABEL.ANON_OBJ='N' and ").append("SPO_LABEL.PREDICATE in (")
                        .append(LabelPredicates.getCommaSeparatedHashes()).append(")");
        ...
        buf =
                new StringBuffer()
                        ...
                        .append(" and SPO_FRESH.LIT_OBJ='Y' and SPO_FRESH.ANON_OBJ='N'").append(" and SPO_FRESH.PREDICATE in (")
                        .append(LabelPredicates.getCommaSeparatedHashes()).append(")").append(" and SPO_FRESH.SOURCE=")
                        .append(sourceUrlHash).append(" and SPO_FRESH.GEN_TIME=").append(genTime).append(" and SPO_ALL.SOURCE<>")
                        .append(sourceUrlHash).append(" and SPO_ALL.GEN_TIME<>").append(genTime);
    ...
    public void deriveParentClasses() throws SQLException {
        ...
        StringBuffer buf =
                new StringBuffer()
                        ...
                        .append("SPO_FRESH.SOURCE, SPO_FRESH.GEN_TIME ").append("from SPO as SPO_FRESH, SPO as SUBCLASS")
                        .append(" where SPO_FRESH.SOURCE=").append(sourceUrlHash).append(" and SPO_FRESH.GEN_TIME=")
                        .append(genTime).append(" and SPO_FRESH.PREDICATE=").append(Hashes.spoHash(Predicates.RDF_TYPE))
                        .append(" and SPO_FRESH.OBJECT_HASH=SUBCLASS.SUBJECT").append(" and SUBCLASS.PREDICATE=")
                        .append(Hashes.spoHash(Predicates.RDFS_SUBCLASS_OF))
        ...
        buf =
                new StringBuffer()
                        ...
                        .append("SPO.SOURCE, SPO.GEN_TIME ").append("from SPO, SPO as SPO_FRESH").append(" where SPO.PREDICATE=")
                        .append(Hashes.spoHash(Predicates.RDF_TYPE)).append(" and SPO.OBJECT_HASH=SPO_FRESH.SUBJECT")
                        .append(" and SPO_FRESH.PREDICATE=").append(Hashes.spoHash(Predicates.RDFS_SUBCLASS_OF))
                        .append(" and SPO_FRESH.LIT_OBJ='N' and SPO_FRESH.ANON_OBJ='N'").append(" and SPO_FRESH.SOURCE=")
                        .append(sourceUrlHash).append(" and SPO_FRESH.GEN_TIME=").append(genTime).append(" and SPO.SOURCE<>")
                        .append(sourceUrlHash).append(" and SPO.GEN_TIME<>").append(genTime);
    ...
    public void deriveParentProperties() throws SQLException {
        ...
        StringBuffer buf =
                new StringBuffer()
                        ...
                        .append("from SPO as SPO_FRESH, SPO as SUBPROP ").append("where SPO_FRESH.SOURCE=").append(sourceUrlHash)
                        .append(" and SPO_FRESH.GEN_TIME=").append(genTime).append(" and SPO_FRESH.PREDICATE=SUBPROP.SUBJECT")
        ...
        buf =
                new StringBuffer()
                        ...
                        .append("from SPO, SPO as SPO_FRESH").append(" where SPO_FRESH.PREDICATE=")
                        ...
                        .append(" and SPO_FRESH.SOURCE=").append(sourceUrlHash).append(" and SPO_FRESH.GEN_TIME=").append(genTime);
    ...
    /** */
    private static final String temp_New_Sources_SQL = "select distinct"
            + " (case when position('#' in URI)>1 then substring(URI from 1 for position('#' in URI)-1) else URI END) as URL"
            + " from" + " SPO, RESOURCE" + " where" + " SPO.SOURCE=?" + " and SPO.GEN_TIME=?" + " and SPO.PREDICATE=?"
            + " and SPO.ANON_OBJ='N'" + " and SPO.OBJECT_HASH=?" + " and SPO.SUBJECT=RESOURCE.URI_HASH";
    ...
    public void extractNewHarvestSources() throws SQLException {
        ...
        StringBuilder bld =
                new StringBuilder("create temp table ").append(tempTableName).append(" on commit drop as ")
                        .append(temp_New_Sources_SQL);
        ...
        bld =
                new StringBuilder().append("insert into HARVEST_SOURCE")
                        .append(" (URL, URL_HASH, TIME_CREATED, INTERVAL_MINUTES, SOURCE, GEN_TIME)")
                        .append(" select URI, URI_HASH, now(),").append(interval).append(",").append(sourceUrlHash).append(", ")
                        .append(genTime).append(" from RESOURCE,").append(tempTableName).append(" where ").append(tempTableName)
                        .append(".URL=RESOURCE.URI");
