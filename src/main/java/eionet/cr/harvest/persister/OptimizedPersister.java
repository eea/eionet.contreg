...
/**
 * OptimizedPersister, which uses LOAD DATA INFILE to
 ...
 */
public class OptimizedPersister implements IHarvestPersister {
	
	private Logger logger = Logger.getLogger(OptimizedPersister.class);
	 ...
	 * @param config
	 */
	public OptimizedPersister(PersisterConfig config) {
		this.config = config;
	}

	/** 
	 * @see eionet.cr.harvest.persister.IHarvestPersister#addResource(java.lang.String, long)
	 * {@inheritDoc}
	 */
	...
	/** 
	 * @see eionet.cr.harvest.persister.IHarvestPersister#closeResources()
	 * {@inheritDoc}
	 */
	...
	/** 
	 * @see eionet.cr.harvest.persister.IHarvestPersister#commit()
	 * {@inheritDoc}
	 */
	...
	/** 
	 * @see eionet.cr.harvest.persister.IHarvestPersister#endOfFile()
	 * {@inheritDoc}
	 */
	...
	/** 
	 * @see eionet.cr.harvest.persister.IHarvestPersister#openResources()
	 * {@inheritDoc}
	 */
	...
	/** 
	 * @see eionet.cr.harvest.persister.IHarvestPersister#rollback()
	 * {@inheritDoc}
	 */
	...
	/** 
	 * @see eionet.cr.harvest.persister.IHarvestPersister#rollbackUnfinishedHarvests()
	 * {@inheritDoc}
	 */
	...
	/** 
	 * @see eionet.cr.harvest.persister.IHarvestPersister#tempCommit()
	 * {@inheritDoc}
	 */
...
//		new File(SOURCE_TEMP_FILE).delete();
	...
	/** 
	 * @see eionet.cr.harvest.persister.IHarvestPersister#getStoredTripleCount()
	 * {@inheritDoc}
	 */
	...
	/** 
	 * @see eionet.cr.harvest.persister.IHarvestPersister#getDistinctSubjectCount()
	 * {@inheritDoc}
	 */
