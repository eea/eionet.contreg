 ...
 */
public final class RecentDiscoveredFilesCache {
	//limit of records inside cache
	private static final int CACHE_LIMIT = 10;
	
	private static RecentDiscoveredFilesCache cache;
	private List<Pair<String,String>> recentFiles;
	
	
	private RecentDiscoveredFilesCache() {
		//singleton pattern
	 ...
	 */
	public static RecentDiscoveredFilesCache getInstance() {
		if (cache == null) {
			cache = new RecentDiscoveredFilesCache();
		}
		return cache;
	}
