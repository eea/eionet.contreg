...
public class FactsheetObjectId {
    ...
    public static String format(ObjectDTO object) {
        ...
        append(object.getHash()).
        append(SEPARATOR).append(object.getSourceHash()).
        append(SEPARATOR).append(object.getDerivSourceHash()).
        append(SEPARATOR).append(object.getSourceObjectHash()).toString();
    }
