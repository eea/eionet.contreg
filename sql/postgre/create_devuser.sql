...
GRANT SELECT,INSERT,UPDATE,DELETE ON harvest, harvest_message, harvest_message, harvest_source, remove_source_queue, resource, resource_temp, spo, spo_temp, unfinished_harvest, urgent_harvest_queue TO cr3dev;
