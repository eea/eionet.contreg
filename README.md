...
All the properties in *local.properties* can be overriden by environment variables.

1. The env variable must have the exact name from *local.properties*
